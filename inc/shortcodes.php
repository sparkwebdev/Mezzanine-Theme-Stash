...
function corner_gallery_email_link($atts) {
	...
	return '<div class="email-link cols"><div class="col col-1-1 col-tight"><h3>Email</h3></div><div class="col col-1-2 col-tight"><p><a href="mailto:'.$email.'">'.$email.'</a></p></div></div>';
}
